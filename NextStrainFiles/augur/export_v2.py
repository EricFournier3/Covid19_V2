...
def set_colorings(data_json, config, command_line_colorings, metadata_names, node_data_colorings, provided_colors, node_attrs):
    ...
    def _get_colorings():
        ...
        if command_line_colorings:
            #print("IN COMMAND LINE COLORING")
