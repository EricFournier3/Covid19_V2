...
def refine(tree=None, aln=None, ref=None, dates=None, branch_length_inference='auto',
    ...
    print("************** CHECK 1 HASATTR CONFIDENCE ",hasattr(tt, 'confidence'))
    ...
    print("************** MARGINAL IS ",str(marginal))
...
def run(args):
    ...
    if args.timetree:
        ...
        print("************ date confidence is ",str(args.date_confidence))
