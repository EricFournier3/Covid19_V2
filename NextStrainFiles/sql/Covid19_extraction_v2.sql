...
FROM (SELECT DISTINCT f.FOLDERNO as NUMERO_SGIL, to_char(cr.BIRTH_DATE, 'YYYY-MM-DD') as DATE_NAISS, 
 ...
 CENTRALRECEIVING cr 
	...
	and rc.RASCLIENTID not in ('LSPQCEC','LSPQCIC','LSPQF','LSPQP','LSPQV','LSPQ') 
        ...
        --AND  f.FOLDERNO in ('L00302426','L00275418','L00272438','L00302432','L00302420') AND ROWNUM < 15 
        --and f.FOLDERNO IN ('L00302415','L00302467','L00302414','L00302413','L00302418','L00302419','L00302412','L00302416','L00302417')
        order by f.FOLDERNO 
);
